...
require_relative "lib/discourse_workspace_groups/remove_channel_group_member"
...
after_initialize do
  ...
  add_to_class(:category, :workspace_events_enabled?) do
    DiscourseWorkspaceGroups.workspace_events_enabled?(self)
  end
